...
This module can also run indipendently from badmoodle, you can launch this script with just the target URL as argument and it will check for this vulnerability.
'''
